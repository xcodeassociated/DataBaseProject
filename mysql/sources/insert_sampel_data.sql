...
INSERT INTO `SysMed`.`PatientExamResult` (`id_patient`, `id_doctor`, `exam_date`, `diagnosis`, `permin_form`, `permin_to`)
	VALUES (1, 3, "2016-12-30 16:00:00", "diagnoza1", "2016-12-30 00:00:00", "2017-01-10 00:00:00");
INSERT INTO `SysMed`.`PatientExamResult` (`id_patient`, `id_doctor`, `exam_date`, `diagnosis`, `permin_form`, `permin_to`)
	VALUES (3, 2, "2017-01-10 11:50:00", "diagnoza2", "2017-01-10 00:00:00", "2017-01-17 00:00:00");
INSERT INTO `SysMed`.`PatientExamResult` (`id_patient`, `id_doctor`, `exam_date`, `diagnosis`, `permin_form`, `permin_to`)
	VALUES (2, 2, "2017-01-04 15:20:00", "diagnoza3", "2017-01-04 00:00:00", "2017-01-21 00:00:00");
INSERT INTO `SysMed`.`PatientExamResult` (`id_patient`, `id_doctor`, `exam_date`, `diagnosis`, `permin_form`, `permin_to`)
	VALUES (1, 1, "2017-01-03 12:00:00", "diagnoza4", "2017-01-03 00:00:00", "2017-01-12 00:00:00");
